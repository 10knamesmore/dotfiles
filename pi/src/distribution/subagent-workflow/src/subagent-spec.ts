...
export const MODEL_DESCRIPTION = 'Required model tier: max, high, or mid. Start with mid for exploration, quick feedback, and well-scoped changes; choose high or max when the child task needs deeper reasoning. Use the current model-tier mappings and guidance in the system prompt. Provider/model-id strings are not accepted. No default or parent-model inheritance.';
