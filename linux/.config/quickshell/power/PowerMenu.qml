...
PanelWindow {
    ...
    Rectangle {
        ...
        Behavior on opacity {
            NumberAnimation { id: _bgAnim; duration: 300; easing.type: Easing.OutCubic }
        }
    }
    ...
    Row {
        ...
        Behavior on opacity {
            NumberAnimation { id: _contentAnim; duration: 300; easing.type: Easing.OutCubic }
        }
        Behavior on scale {
            NumberAnimation { duration: 300; easing.type: Easing.OutCubic }
        }

        PowerButton { icon: "";  label: "锁屏"; command: "hyprlock" }
        PowerButton { icon: "󰍃"; label: "注销"; command: "hyprctl dispatch exit" }
        PowerButton { icon: "󰤄"; label: "挂起"; command: "systemctl suspend" }
        PowerButton { icon: "";  label: "重启"; command: "systemctl reboot" }
        PowerButton { icon: "";  label: "关机"; command: "systemctl poweroff" }
    }
    ...
    component PowerButton: Rectangle {
        ...
        width: 100; height: 110; radius: 16
